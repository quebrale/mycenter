...
createAluno (data: dadosAluno) {
  ...
  readAluno (id : string) {
    return this.alunos.find( item => item.aluno_id === id )
  }

  updateAluno (id : string, aluno: dadosAluno) {
  ...
  deleteAluno (id : string) {
    this.alunos = this.alunos.filter(aluno => aluno.aluno_id !== id)
